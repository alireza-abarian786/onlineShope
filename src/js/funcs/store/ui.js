...
//   document.querySelector(".container-category__footer").innerHTML = ""; //? پاک کردن محتوای قبلی

//   if (arrCategory.length) {
//     //? اگر محصولی وجود داشت، نمایش بده
//     arrCategory.forEach(async (product) => {
//       document.querySelector(".container-category__footer").insertAdjacentHTML(
//         "beforeend",
//         `
...
//     //? اگر محصولی پیدا نشد، پیام خطا نمایش بده
//     document
//       .querySelector(".container-category__footer")
//       .insertAdjacentHTML(
//         "beforeend",
//         `<div class='alert alert-danger w-100 text-center'>:( کالای مورد نظر شما یافت نشد ):</div>`
//       );
